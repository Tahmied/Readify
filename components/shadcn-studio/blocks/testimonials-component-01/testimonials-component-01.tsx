    ...
    <section className='py-8 sm:py-16 lg:py-24'>
      ...
      >
        ...
        <div className='space-y-4 sm:w-1/2 lg:w-1/3'>
          ...
          <h2 className='text-2xl font-semibold sm:text-3xl lg:text-4xl'>What Readers Say</h2>

          <p className='text-muted-foreground text-xl'>
            Hear from our happy readers and book lovers
          </p>

          <div className='flex items-center gap-4'>
            <CarouselPrevious
              variant='default'
              className='static translate-y-0 rounded-[30px] bg-[#eb7c1f] text-white hover:bg-[#eb7c1f]/80 disabled:bg-gray-300 disabled:opacity-50'
            />
            <CarouselNext
              variant='default'
              className='static translate-y-0 rounded-[30px] bg-[#eb7c1f] text-white hover:bg-[#eb7c1f]/80 disabled:bg-gray-300 disabled:opacity-50'
