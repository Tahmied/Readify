...
const BooksPage = () => {
  ...
  const handleAddNew = () => {
    alert('Add New Book functionality');
  };
                ...
                <div className="p-5">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-gray-100 text-gray-700 px-3 py-2 rounded-lg font-medium hover:bg-gray-200 transition-colors duration-200 flex items-center justify-center gap-1.5 cursor-pointer"
                      title="View Details"
                    >
                      <Eye size={16} />
                    ...
                    <button
                      ...
                      className="flex-1 bg-[#eb7c1f] bg-opacity-10 text-[#eb7c1f] px-3 py-2 rounded-lg font-medium hover:bg-opacity-20 transition-colors duration-200 flex items-center justify-center gap-1.5 cursor-pointer"
                      title="Edit Book"
                    >
